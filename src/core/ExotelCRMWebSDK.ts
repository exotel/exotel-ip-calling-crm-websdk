...
import { IWebRTCClient, CallListenerCallback, RegisterListenerCallback } from '../interfaces/IWebRTCClient';
import { WebRTCClientImpl } from '../implementations/WebRTCClientImpl';
...
export default class ExotelCRMWebSDK {
  ...
  constructor(
    ...
    this.#webRTCClient = webRTCClient || new WebRTCClientImpl(accesssToken, null);
  }
   ...
   */
  async Initialize(
    sofPhoneListenerCallback: CallListenerCallback,
    softPhoneRegisterEventCallBack?: RegisterListenerCallback,
